...
{
    [DbContext(typeof(ChillClosetContext))]
    [Migration("20250620123104_AddRefundDetailsToReturnRequest")]
    partial class AddRefundDetailsToReturnRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chill_Closet.Models.Order", b =>
                {
                    ...
                    b.Property<bool>("IsLateVoucherIssued")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Chill_Closet.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Chill_Closet.Models.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Chill_Closet.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("Chill_Closet.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Chill_Closet.Models.Product", b =>
                {
                    b.HasOne("Chill_Closet.Models.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Chill_Closet.Models.ApplicationUser", null)
                        .WithMany()
